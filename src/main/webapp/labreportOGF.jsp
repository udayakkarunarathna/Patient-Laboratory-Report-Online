...
String header_include1 = "", header_include2 = "", uc = "";
String Spe = "";
String[] Spe_arr = null;
...
<body class="A4" <%if(ac.equals("print")){ %> onload="this.window.print()" <%} %>>
	...
	try {
		...
		if(lh.equals("true")){
			header_include1 = "background: white url('images/header1.png') no-repeat center; background-size: 100% 100%;";
			header_include2 = "background: white url('images/header2.png') no-repeat center; background-size: 100% 100%;";
		}
	%>

	<section class="sheet padding-5mm"  style="<%=header_include1%>">
		...
		<article>
			<header>
				...
				%>
				<%@include file="newjsp_LHcovidOGF.jspf"%>
				<%
				} else if (covd > 0) {
				%>
				<%@include file="newjspcovidOGF.jspf"%>
				<%
				} else if (lh.equals("false")) {
				%>
				<%@include file="newjspOGF.jspf"%>
				<%
				} else {
				%>
				<%@include file="newjsp_LHOGF.jspf"%>
				<%
				}
			...
			<div id="content">
					<table align="right" width="97%" style="font-size: 10pt; border-collapse: collapse;" border="0">
						<tr>
							<td colspan="5" height="30pt"></td>
						</tr>
						<%
						...
						%>
						<tr><td colspan="5" height="10pt"></td></tr>
						<tr class="testHeader">
						...
						%>
						<tr class="boldCls testsBody">
							<td height="10px"><%=desc%></td>
							<td align="center"><%=Normal%></td>
							<td><%=units%></td>
							<td align="center"><%if(Flag.equals("**")){%><span class="checked"><b>*</b></span><%}%></td>
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=tok11%></td>
						</tr>
						<%if(test_code.equals("T000004")){ %>
						<tr>
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=tok110%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=temp%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=desc%></td>
						</tr>
						<%
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=tok1%></td>
						</tr>
						<%
						}
						if (refextra.equals(" ") || refextra.equals("-")) {
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=tempp%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=tok2%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<tr class="boldCls">
							<td height="10px" colspan="5" style="color: blue">WBC/DC</td>
						</tr>
						<%
						}
						%>						
						...
						<tr class="boldCls testsBody">
							...
							<td align="center"><%=normal_res%></td>
							<td><%=spunits%></td>
							<td align="center"><%if(result_flag.equals("**")){%><span class="checked"><b>*</b></span><%}%></td>
						...
						<tr class="boldCls testsBody">
							<td height="10px"><%=spdescription%></td>
							<td align="center"><%=df3.format(tmpRes)%></td>
							<td><%=spunits%></td>
							<td><%=result_flag%></td>
							<td align="center"><%=ref_range_sp%></td>
						</tr>
						...
						%>
						<tr>
							<td height="10px" colspan="5" class="commetsSec"><%=temp5%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<tr class="boldCls" >
							<td height="10px" colspan="5" style="color: blue"><%=profileDes%></td>
						</tr>
						<tr><td colspan="5" height="10pt"></td></tr>
						<tr class="testHeader">
							<td height="20px" >TEST NAME</td>
							<td align="center">RESULT</td>
							<td>UNITS</td>
						...
						%>
						<%@include file="ref_extrajspOGF.jspf"%>
						<%
						}
					...
					<tr>
						...
						<tr>
							<td height="10px" colspan="5" class="commetsSec"
								class="boldCls"><%=desc%></td>
						</tr>
						<%
						...
						%>
						<tr>
							<td colspan="5" class="commetsSec"><%=tok1%></td>
						</tr>
						<%
						}
						}
						...
						%>
						<!-- <tr>
							<td height="10px" colspan="5" align="center">- End Of Report
								-</td>
						</tr> -->
						<%
						}
						...
						try {
							...
							query7702 = "SELECT INITCAP(L.NAME_BHT),L.EMAIL,'1' FROM LAB_TEST_INVOICES@COLOMBO_LIVE L WHERE L.INVOICE_NO = '"
...
if(lh.equals("true")){	
	%>
	<section class="sheet padding-5mm" style="<%=header_include2%>">
		<article>
			<table width="100%" style="font-size: 10pt" border="0">
				<tr>
					<td height="10px" colspan="5" style="white-space: pre-wrap;"></td>
				</tr>
			</table>
		</article>
	</section>
